...
gxp.plugins.streetviewtool = Ext.extend(gxp.plugins.Tool, {
	...
	//This tool is a quick mod of a wms_getfeatureinfo tool, which doesn't make much sense
	//Too much unneeded code here, it does the job for now but cleanup is required
    
    /** api: ptype = gxp_wmsgetfeatureinfo */
    ptype: "app_streetviewtool",
